...
Route::post('/emailtest','UserController@emailtest');

Route::get('/','UserController@index');
Route::get('logout','UserController@logout')->name('logout');
Route::post('change-password','UserController@change_password')->name('change-password');
Route::post('signup','UserController@signup');
Route::get('reset-password/{enc_email}','UserController@reset_password');
...
Route::post('/get-pre-foot','UserController@get_pre_foot');
Route::post('/get-next-foot','UserController@get_next_foot');

Route::post('/get-surah-search-verse','UserController@get_surah_search_verse');
...
Route::post('/get-raku','UserController@get_raku');
