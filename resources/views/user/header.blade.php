...
<body>
  <section id="container">
      ...
      <section class="panes_box" id="home_menu" style='position:relative;'>
        <div class="aboveDrawer" data-toggle="tooltip" title='Surah Introduction'>
          <div class="content">
            ...
            <div class="col-md-12">
              <span id="c-surah"
                style="line-height: 1.2 !important; line-height: 1.2 !important;display: grid;justify-content: center;">{!!
                $surah->introduction !!}</span>
            </div>
          </div>
          {{-- </div> --}}
          <div class="open">
        ...
        <option value="{{$i}}">{{$i}}</option>
                    ...
                    <div class="input-group Qinput">
                      <input onfocus="from()" onkeyup="this.value=this.value.replace(/[^\d]/,'')" type="text"
                        id="cmbFVerse1" value="1" class="form-control">
    ...
    border-radius: 10px;" id="cmbFVerse" class="slectedopt fromdrop btn btn-default verseSelector">
                    ...
                    <label class="trn" style="margin-left: 197px; margin-top:7px; line-height: 15px !important">To
                      Verse</label>
       ...
       @for(@$i=$surah->verses;$i>=1;$i--)
        <option value="{{$i}}">{{$i}}</option>
                    ...
                    <div class="input-group Qinput" style="margin-left: 276px;">
                      <input onfocus="to()" type="text" id="cmbTVerse1"
                        onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="{{ $surah->verses }}"
                        class="form-control">
                      <div class="input-group-btn">
       ...
       <option value="4">1 &#190;</option> --}}
                ...
                <li>
                  <section class="script_box">
                    ...
                    <a href="javascript:;" onclick="return mute();" class="container_btn1 un" id="btnMAA"
                      title="Arabic Audio">
                      <img id="btnMAA_Img" src="https://read.quranexplorer.com/public/Images/Quran/spacer.gif"
                        alt="Mute Arabic Audio"/ class="mute-icon">
                  ...
                  <section>
                    ...
                    <div id="CP_ForeColor">
                      ...
                      <div id="CP_BackColor">
                        ...
                        <div id="CP_BackColorInSide"
                          style="color:#f2db8c; cursor:pointer; display:inline; font-family:Arial; font-size:21px;">
                          █
              ...
              <ul>
                <li>
                  <section class="nav_box" style="width: auto" ;>
                    ...
                    <select class="cmbSearchLanguage-search-section" id="cmbSearchLanguage" name="ResourceID"
                      style="width: 236px;">
                ...
                <li>
                  <section class="text_search nav_box">
                    <div class="input-group mb-3" style="flex-wrap: nowrap;">
                      <input id="txtSearchText" type="text" class="form-control p-0" value=""
                        style="background: #8a2b44; border-radius: 10px; border: none; color: #fff;">
                      <div class="input-group-append">
                        <a href="#" id="searchBtn"> <span class="input-group-text bg-white"> <i
