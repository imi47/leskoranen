		        ...
		        <div class="panel-body">
		            <form method="POST" action="{{ route('post-admin') }}" id="sub-form">
		            	...
		            	<div class="row">
                          ...
                          <input type="text" value="{{ $edit->username }}" name="username" class="form-control" placeholder="User Name">
                          <div class="form-feedback"></div>
                      </div>
		            		</div>
                    <div class="col-md-4">
                      <div class="form-group nsurahnamearabic">
                          ...
                          <input type="text" name="email" value="{{ $edit->email }}" class="form-control" placeholder="Email">
                    ...
                    <div class="col-md-4">
                      <div class="form-group nsurahnumber">
                          ...
                          <input type="number" name="phone" value="{{ $edit->phone }}" class="form-control" placeholder="Phone number">
                          <div class="form-feedback"></div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group nsurahjuznumber">
                          ...
                          <input type="password" name="password" value="{{ $edit->password }}" class="form-control"  placeholder="Password">
                          <div class="form-feedback" ></div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group nsurahjuznumber">
                          ...
                          <input type="password" name="password_confirmation" value="{{ $edit->password }}" class="form-control"  placeholder="Confirm password">
                          <div class="form-feedback" ></div>
                      </div>
                    </div>
