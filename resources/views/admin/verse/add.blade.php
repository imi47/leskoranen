		...
		<div class="col-md-12">
		    <div class="panel panel-bd">
		        ...
		        <div class="panel-body">
		            <form method="POST" action="{{ route('post-verse') }}" id="sub-form" enctype="multipart/form-data">
		            	@csrf
		            	<div class="row">
		            		<div class="col-md-12">
				            	<div class="form-group nversearabic">
                          <label for="editor1">Arabic (With Immune)</label>
                          <textarea id="editor1" dir="rtl" name="nversearabic" class="form-control" style="resize: vertical;"></textarea>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group nnortrans">
                          ...
                          <textarea id="editor3" name="nnortrans" class="form-control" style="resize: vertical;"></textarea>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group nversenum">
                          ...
                          <input type="number" name="nversenum" class="form-control" id="verse-num" placeholder="From 1 to {{ $surah->verses }}">
                    ...
                    <div class="col-md-3">
                      <div class="form-group njuzzid">
                          ...
                          <input type="number" name="njuzzid" class="form-control" id="verse-juz" placeholder="From 1 to 30">
                    ...
                    <div class="col-md-6">
                      <div class="form-group nruku">
                          ...
                          @if($surah->raku <> 1)
                            <input type="number" name="nruku" class="form-control" id="ruku-id" placeholder="e.g., 1 to {{ $surah->raku }}">
                          @else
                            <input type="number" readonly="" name="nruku" value="{{ $surah->raku }}" class="form-control" id="ruku-id">
                          @endif
...
@push('css')
  ...
  {{-- <script type="text/javascript" src="{{ url('public/ck/ckeditor.js') }}"></script> --}}
  {{-- <script src="{{ url('public') }}/ck/adapters/jquery.js"></script> --}}
@endpush
